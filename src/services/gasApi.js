...
async function request(action, payload = {}) {
  if (!appConfig.gasWebAppUrl) {
    return { ok: false, offline: true, message: 'GAS Web App URL is not configured yet.' };
  }
...
export const gasApi = {
  ...
  uploadProjectFile: (payload) => request('uploadProjectFile', payload),
  deleteProjectFile: (payload) => request('deleteProjectFile', payload)
};
